...
<div class="card-title">
    <h3 class="card-label">
        Niveles de madurez
        <span class="d-block text-muted pt-2 font-size-sm">Cree, edite o elimine los niveles de madurez</span>
    </h3>
</div>
<div class="card-toolbar">
   
<!--begin::Button-->
<a href="{{ route('madurityLevel.create') }}" class="btn btn-primary font-weight-bolder">
...
</svg><!--end::Svg Icon--></span>	Nuevo Nivel
</a>
<!--end::Button-->
</div>
</div>
...
<table class="table table-bordered table-checkable" id="kt_datatable">
    <thead>
        <tr>                        
            ...
            <tbody>
                @foreach($madurityLevel as $level)
                    <tr>
                        <td>{{$level->id}}</td>
                        <td>{{$level->name}}</td>
                        ...
                        <td><a href="{{route('madurityLevel.edit', $level->id)}}" class="btn btn-primary">Editar</a> </td>
                    </tr>
                @endforeach
            </tbody>
        </table>
