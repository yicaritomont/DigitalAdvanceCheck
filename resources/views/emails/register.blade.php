								...
								<table class="full" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
																	...
																	<table style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align: center;" class="fullCenter" width="300" cellspacing="0" cellpadding="0" border="0" align="left">
																		...
																		<tr>
																			<td style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Raleway'; font-size:26px; color: #303030; line-height: 32px; font-weight:300;" class="raleway inline fullCenter" width="100%" valign="top">
																				<p>Bienvenido</p> 
																				<p><span style="font-weight:800; text-decoration:underline;">{{$datos['perfil']}}</span></p>
																			    <p><span style="font-weight:800; text-decoration:underline;">{{$datos['nombre_persona']}}</span></p>
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			<td style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 15px; color: #6e6e6e; line-height: 24px; font-weight: 400;" class="fullCenter" width="100%" valign="top">
																				<p>Antes de empezar a utilizar nuestros servicios necesitamos validar que eres el propietario de esta dirección de e-mail.</p>
																			</td>
																		</tr>
																											...
																											<tbody>
																												<tr>
																													<td style="font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 18px; line-height: 24px; font-weight:600;" class="opensans" height="32" align="center">
																													 <a href={{ url('/register/verify/' . $datos['confirmation_code']) }} style="color: #ffffff; display: block !important; line-height: 20px!important; padding-left:25px; text-transform:uppercase; padding-right:25px; text-decoration: none; padding-top: 15px; padding-bottom: 15px;" target="_blank"><silgleline> Confirmar Correo Electrónico. </silgleline> </a>  
																													</td>
																												</tr>
																											</tbody>
																										</table>
																		...
																		<tr>
																			<td width="100%" height="20" class="h30"></td>
																		</tr>
																		<tr>
																			<td style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 15px; color: #6e6e6e; line-height: 24px; font-weight: 400;" class="fullCenter" width="100%" valign="top">
																				<p>Una vez validemos tu e-mail podrás acceder.</p>
																			</td>
																		</tr>
																		<!-- End Button -->
												...
												<tbody>
												  <tr>                                                
													...
													<td align="right" class="image400">                                    
													  <a style="text-decoration: none;"> 
														  <img src="http://expoasoinducalscuero.com/images/templates/base-emails/img04.png" width="400" alt="" border="0" class="hover" style="width: 400px;">
													   </a>                                    
													</td>
												</tr>
											</tbody></table>
									...
									<tr>
										<td style="text-align: center; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 16px; color: #6e6e6e; line-height: 24px; font-weight: 400; padding-left: 120px;padding-right: 120px;" class="fullCenter" width="100%" valign="top">
											<p>Si has recibido este e-mail y no tienes información de la empresa que te contacta, haz caso omiso a este e-mail, ya que alguien por error debe haber escrito tu dirección.</p>
