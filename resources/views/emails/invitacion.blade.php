										...
										<td align="center">
																	...
																	<table style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align: center;" class="fullCenter" width="300" cellspacing="0" cellpadding="0" border="0" align="left">
																		...
																		<tr>
																			<td style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Raleway'; font-size:26px; color: #303030; line-height: 32px; font-weight:300;" class="raleway inline fullCenter" width="100%" valign="top">
																				Bienvenido<span style="font-weight:800; text-decoration:underline;"> <br> {{$datos['NombreInvitado']}}</span> 
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			<td style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 16px; color: #6e6e6e; line-height: 24px; font-weight: 400;" class="fullCenter" width="100%" valign="top">
																				<p>Recibe un afectuoso saludo, el Sr(a): <br>
																				<strong style="color: #212222;">{{$datos['PersonaInvita']}}</strong><br> 
																				En nombre de la empresa: <br> 
																				<strong style="color: #212222;">{{$datos['EmpresaInvita']}}</strong> <br>
																				le invita a que lo acompañe en la feria, como colaborador. Además envían el siguiente mensaje:</p> <br>
																				<p style="color: #212222;">{{$datos['MensajeInvitacion']}}</p> <br>
																				<p>Si deseas aceptar esta invitación, por favor has clic en el siguiente enlace:</p>
																			</td>
																		</tr>
																		...
																		<!-- Buttons -->
																		<tr>
																			<td align="left" width="100%" class="fullCenter">
																				<table border="0" cellpadding="0" cellspacing="0" align="left" class="fullCenter">
																				<tbody>
																					<tr>
																					  <td align="left" class="fullCenter">											  
																						  <table align="left" border="0" cellpadding="0" cellspacing="0" class="buttonScale">
																							<tbody>
																								<tr>
																									<td align="center" width="100%" class="hover">
																										<table align="center" cellpadding="0" cellspacing="0" style="border-radius: 50px;padding-bottom: 0px; font-weight: 400; background:#38ef7d; border-width:0 0 4px; border-style: solid; border-color: #2cd56c;" bgcolor="#38ef7d" width="100%">
																											<tbody>
																												<tr>
																													<td style="font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; font-size: 18px; line-height: 24px; font-weight:600;" class="opensans" height="32" align="center">
																													 <a href={{ url('/invitacion/aceptar/' . $datos['TokenInvitacion']) }} style="color: #ffffff; display: block !important; line-height: 20px!important; padding-left:25px; text-transform:uppercase; padding-right:25px; text-decoration: none; padding-top: 15px; padding-bottom: 15px;" target="_blank"><silgleline> Aceptar Invitación</silgleline> </a>  
																													</td>
																												</tr>
																											</tbody>
																										</table>
												...
												<tbody>
												  <tr>                                                
													...
													<td align="right" class="image400">                                    
													  <a style="text-decoration: none;"> 
														  <img src="http://expoasoinducalscuero.com/images/templates/base-emails/img03.png" width="400" alt="" border="0" class="hover" style="width: 400px;">
													   </a>                                    
													</td>
												</tr>
											</tbody></table>
											<table class="full" width="50%" cellspacing="0" cellpadding="0" border="0" align="right">
												<tbody>
													...
													<tr>
														<td style="text-align: right; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 16px; color: #6e6e6e; line-height: 24px; font-weight: 400; padding-right: 60px; padding-left: 40px;" class="fullCenter" width="100%" valign="top">
															<p>También entendemos si no deseas aceptar la invitación, por favor háznolo saber y da clic en el siguiente enlace:</p>
															<a href="{{ url('/invitacion/rechazar/' . $datos['TokenInvitacion']) }}" style="color: #2cd56c;"><strong>Rechazar la Invitación.</strong></a>
														</td>
													</tr>
													<tr>
														<td width="100%" height="15" class="h20"></td>
													</tr>
