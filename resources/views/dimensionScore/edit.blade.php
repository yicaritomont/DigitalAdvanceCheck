	...
	<div class="col-lg-12">
		...
		<div class="card card-custom gutter-b example example-compact">
			<div class="card-header">
				<h3 class="card-title">
					Editar Puntaje de dimensión.
				</h3>
				
			</div>
			{{Form::model($dimensionScore, ['route' => ['dimensionScore.update', $dimensionScore->id], 'method' => 'put'])}}
			@csrf
			<div class="card-body">
				<div class="form-group">					
           		...
           		<div class="card-footer">
					...
					<a href="{{route('dimensionScore.index')}}" class="btn btn-secondary">Volver</a>
				</div>
